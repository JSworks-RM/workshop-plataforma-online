...
const Banner = ({ color, image, title, subtitle, home, poster, courseBanner, speciality, info }) => (
        ...
        />
        {
          ...
          <div className="ed-grid m-grid-2">
            ...
            <div className="img-container s-ratio-16-9">
              <img src={poster} alt="Diseño de interfaces"/>
            </div>
          </div>
          :
            courseBanner ?
            <div className="ed-grid m-grid-3">
              <div className="main-banner__data m-cols-2">
                ...
                <p>{info}</p>
                <p>Este curso forma parte de la especialidad <Link to="/especialidades">{speciality}</Link></p>
              </div>
